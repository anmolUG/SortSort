...
document.addEventListener("DOMContentLoaded", function () {
  var toggle = document.getElementById("complexity-toggle");
  var dropdown = document.getElementById("complexity-dropdown");
  if (toggle && dropdown) {
...
// Staggered animation for array bars on page load
window.addEventListener("DOMContentLoaded", function () {
  var bars = document.querySelectorAll("#array_container div");
  bars.forEach(function (bar, idx) {
    bar.style.setProperty("--bar-delay", idx * 0.025 + "s");
  });
});
